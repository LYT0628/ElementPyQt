...
# 标题栏基类， 负责发送窗口的 移动， 最大化， 最小化 和 关闭信号
class EAbstractTitleBar(QWidget):
    # 通知窗口最小化
...
class EAbstractFramelessWindow(QWidget):
    def __init__(self):
        super().__init__()
        # 标题栏
        self._titleBar = EDefaultTitleBar()
...
class EDefaultTitleBar(EAbstractTitleBar):
...
class EDefaultWindow(EWindowResizable, EAbstractFramelessWindow):
    Margins = 5
    ...
    def _initialUi(self):
        ...
        self._titleBar = EDefaultTitleBar(self)
